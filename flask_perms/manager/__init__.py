...
from ..settings import defaultPermissions

from .parsers import TemplateParser, PyMain


def _createManager(ext, app, db):
    ...
    class PermissionManager:
        ...
        def __init__(self, path=ext.root_path, rootRole=ext.root_role):
